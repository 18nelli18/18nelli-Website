...
[https://ghostty.org/](https://ghostty.org/): Terminal

[https://pi.dev/](https://pi.dev/): CLI de codage argentique

[https://help.router-for.me/](https://help.router-for.me/): Pour récupérer les clé API d’abonnement  mensuel classique

[https://tmux.app/](https://tmux.app/)
...
[https://github.com/hazat/pi-interactive-subagents](https://github.com/hazat/pi-interactive-subagents): lancer des sous-agents

[https://github.com/nicobailon/pi-web-access](https://github.com/nicobailon/pi-web-access): recherche sur le web

[https://github.com/deevus/pi-wayfinder](https://github.com/deevus/pi-wayfinder): navigation structurelle du code (pour éviter que les longs codes dérivent)

[https://github.com/michaelmjhhhh/pi-atelier](https://github.com/michaelmjhhhh/pi-atelier): UI améliorée

[https://github.com/nicobailon/pi-mcp-adapter](https://github.com/nicobailon/pi-mcp-adapter): Utilisation de serveur MCP

[https://github.com/juicesharp/rpiv-ask-user-question](https://github.com/juicesharp/rpiv-ask-user-question): Pose des questions à l’utilisateur plutôt que de partir à l’aveugle

[https://github.com/mksglu/context-mode](https://github.com/mksglu/context-mode): Réduit la taille du contexte sans perte
...
Après le test du setup pour PCB, je suis tombé sur une vidéo qui présente un workflow d’apprentissage avec Pi: [https://www.youtube.com/watch?v=kzcI5F4tGiU&t=803s](https://www.youtube.com/watch?v=kzcI5F4tGiU&t=803s)
...
![image 1.png](Setup%20IA/image%201.png)
...
![Capture_decran_2026-09-11_a_16.16.37.png](Setup%20IA/Capture_decran_2026-09-11_a_16.16.37.png)
...
Petit retour sur le setup d’apprentissage. J’ai demandé d’apprendre à implémenter en vhdl un processeur risc-v rv32i pour mon fpga. J’ai eu 2 leçons, et ça m’a l’air pourtant assez fiable. J’ai d’abord bien un cours claire, avec souvent 1 ou 2 diagrammage d’explication, puis j’ai un TP complet à faire, avec des rendus claire et strict. L’ia me refuse souvent mes dépots, elle a des exigence et veut de la rigueurs. Le meilleur PoC serait d’aller au bout de cet apprentissage pour prouver que ce setup permet vraiment d’apprendre.

Les diagrammes générés sont vraiment bon:

![Capture_decran_2026-09-15_a_00.43.38.png](Setup%20IA/Capture_decran_2026-09-15_a_00.43.38.png)

![Capture_decran_2026-09-15_a_00.43.18.png](Setup%20IA/Capture_decran_2026-09-15_a_00.43.18.png)

![Capture_decran_2026-09-15_a_00.55.43.png](Setup%20IA/Capture_decran_2026-09-15_a_00.55.43.png)
